...
import "./ProductOfferTemplate.css"
import ChevronRightIcon from '@mui/icons-material/ChevronRight';

function ProductOfferTemplate() {
  ...
  return (
    <>
    <div className='product-offer-main-continer'>

        <div className='product-offer-sub-continer'>

                <div className='product-offer-left-continer'>
                    <div className="Products-offer-headertext-link-continer">
                    <p className="product-offer-header">{"Beaty, Food, Toys & more"}</p>
                    <button className="Products-offer-headertext-link-button">
                    <ChevronRightIcon  style={{ fontSize:"", color:"#FFF"}} />
                    </button>
                    </div>
                        <div className="product-offer-products-continer">  
                            {
                            products.map((productsdetails, index)=>{
                                return(
                            <div className="product-offer-items">
                                <div className="product-offer-img-continer">
                                    <img src={productsdetails.img} alt="items"/>
                                </div>
                                <p className="product-offer-products-name">{productsdetails.name}</p>
                                <p className="product-offer-products-price">From ${productsdetails.price}</p>
                            </div>
                                )
                            })}
                        </div>
                 ...
                 <div className='border-class product-offer-right-continer'>
                    <img src='https://images.fonearena.com/blog/wp-content/uploads/2022/04/image001.jpg' alt='local error' />
                 </div>
    </div>
