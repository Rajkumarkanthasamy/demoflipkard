...
function SportsBooksMore() {
  ...
  return (
    <div className='moreproducts-continer' onMouseOver={handleClick} onMouseLeave={handleClose} >
    <div>
      <img src='https://rukminim1.flixcart.com/flap/100/100/image/dff3f7adcf3a90c6.png?q=100' alt='inter-net'/>
    </div>
     <div >
      <Button
...
export default SportsBooksMore