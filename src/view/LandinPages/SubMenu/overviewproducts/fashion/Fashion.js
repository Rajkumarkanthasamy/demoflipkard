...
function Fashion() {
  ...
  return (
    <div className='fashion-continer' onMouseOver={handleClick} onMouseLeave={handleClose} >
    <div>
      <img src='https://rukminim1.flixcart.com/fk-p-flap/100/100/image/0d75b34f7d8fbcb3.png?q=100' alt='inter-net'/>
    </div>
     <div >
      <Button
